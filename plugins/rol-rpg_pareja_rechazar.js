...
if(user === conn.user.jid) return await conn.sendButton(m.chat, `𝒀𝒐 𝒏𝒐 𝒑𝒖𝒆𝒅𝒐 𝒔𝒆𝒓 𝒕𝒖 𝒑𝒂𝒓𝒆𝒋𝒂 𝒑𝒐𝒓𝒒𝒖𝒆 𝒏𝒐 𝒆𝒓𝒆𝒔 𝒊𝒏𝒔𝒂𝒏𝒐 𝒄𝒐𝒎𝒐 𝒚𝒐 👻`, wm, null, [
['𝐌𝐄𝐍𝐔 ♨️', '/menu']], fkontak, m)
...
['𝐌𝐄𝐍𝐔 ♨️', '/menu']], fkontak, m, { contextInfo: { mentionedJid: [user, tu]}})	
...
['𝐌𝐄𝐍𝐔 ♨️', '/menu']], m, fkontak, { contextInfo: { mentionedJid: [user, tu, yo]}})	
}}}
