...
`.trim()
                    if (global.db.data.users[m.sender].common >= 1) {
                        ...
                        global.db.data.users[m.sender].uncoommon += cu * 1
...
`.trim()
                    if (global.db.data.users[m.sender].common >= 10) {
                        ...
                        global.db.data.users[m.sender].uncoommon += cu1 * 1
...
`.trim()
                    if (global.db.data.users[m.sender].common >= 100) {
                        ...
                        global.db.data.users[m.sender].uncoommon += cu2 * 1
...
`.trim()
                    if (global.db.data.users[m.sender].common >= 1000) {
                        ...
                        global.db.data.users[m.sender].uncoommon += cu3 * 1
...
`.trim()
                    if (global.db.data.users[m.sender].uncoommon >= 1) {
                        global.db.data.users[m.sender].uncoommon -= 1
                        global.db.data.users[m.sender].money += um * 1
                        global.db.data.users[m.sender].diamond += ud * 1
                        global.db.data.users[m.sender].iron += ue * 1
                        global.db.data.users[m.sender].potion += up * 1
                        global.db.data.users[m.sender].common += uc * 1
                        global.db.data.users[m.sender].uncoommon += uu * 1
...
`.trim()
                    if (global.db.data.users[m.sender].uncoommon >= 10) {
                        global.db.data.users[m.sender].uncoommon -= 10
                        ...
                        global.db.data.users[m.sender].uncoommon += uu1 * 1
...
`.trim()
                    if (global.db.data.users[m.sender].uncoommon >= 1000) {
                        global.db.data.users[m.sender].uncoommon -= 1000
                        ...
                        global.db.data.users[m.sender].uncoommon += uu3 * 1
...
`.trim()
                    if (global.db.data.users[m.sender].mythic >= 1) {
                        ...
                        global.db.data.users[m.sender].uncoommon += mu * 1
                        global.db.data.users[m.sender].iron += 60 * 1
...
`.trim()
                    if (global.db.data.users[m.sender].mythic >= 10) {
                        ...
                        global.db.data.users[m.sender].uncoommon += mu1 * 1
...
`.trim()
                    if (global.db.data.users[m.sender].mythic >= 100) {
                        ...
                        global.db.data.users[m.sender].uncoommon += mu2 * 1
...
`.trim()
                    if (global.db.data.users[m.sender].mythic >= 1000) {
                        ...
                        global.db.data.users[m.sender].uncoommon += mu3 * 1
...
`.trim()  
                    if (global.db.data.users[m.sender].legendary >= 1) {
                        ...
                        global.db.data.users[m.sender].uncoommon += lu * 1
...
`.trim()  
                    if (global.db.data.users[m.sender].legendary >= 10) {
                        ...
                        global.db.data.users[m.sender].uncoommon += lu1 * 1
...
`.trim()  
                    if (global.db.data.users[m.sender].legendary >= 100) {
                        ...
                        global.db.data.users[m.sender].uncoommon += lu2 * 1
...
`.trim()  
                    if (global.db.data.users[m.sender].legendary >= 1000) {
                        ...
                        global.db.data.users[m.sender].uncoommon += lu3 * 1
