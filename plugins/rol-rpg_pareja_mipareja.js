...
['𝐌𝐄𝐍𝐔 ♨️', '/menu']], fkontak, m, {contextInfo: { mentionedJid: [ m.sender, who ] }})
...
['𝐌𝐄𝐍𝐔 ♨️', '/menu']], fkontak, m, {contextInfo: { mentionedJid: [ persona, m.sender ] }})
global.db.data.users[m.sender].pasangan = ""
}
handler.command = /^(sinceridad|mipareja|miamor|minovio|minovia|mylove|compañero)$/i
handler.group = true
