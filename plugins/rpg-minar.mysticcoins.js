...
'has vendido tu alma por un super pico y has minado',
'has encontrado una fuga de gemas y agarras',
'🌀 viajas por un portal mistico y encuentras',
...
let rock = `${pickRandom([6, 9, 0, 12, 80])}` * 1
...
let wood = `${pickRandom([21, 0, 11, 89, 27])}` *1
const recompensas = {	
